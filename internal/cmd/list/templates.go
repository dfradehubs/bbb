...
const (
	...
	{Bold}{White}console ~$ {Green}bbb connect mysql {Cyan}{ttcp_example} [--database=<database>] [--extraArgs=<extra>]{Reset}

	Remember to use {Bold}{Cyan}ssh{Reset}, {Bold}{Cyan}kube{Reset}, {Bold}{Cyan}browser{Reset} or 
	{Bold}{Cyan}mysql{Reset} subcommand depending on the target you are trying to connect to.`
